...
#define MCHAN_BASE_ADDR                                                        \
  (CLUSTER_PERIPHERALS_ADDR + CLUSTER_MCHAN_OFFSET) // CLUSTER_MCHAN_ADDR
#endif
#define MCHAN_EVENT
// #define MCHAN_POLLED
#ifdef MCHAN_EVENT
#define MCHAN_EVENT_BIT (CLUSTER_IRQ_DMA0) // 8
#endif
#include "mchan.h"
...
void dory_dma_memcpy_hwc_to_chw(DMA_copy *copy) {
  ...
  int Log2Core = log2(log2(NUM_CORES));
