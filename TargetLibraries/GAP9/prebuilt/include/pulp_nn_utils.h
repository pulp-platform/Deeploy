...
#ifdef __clang__
#define bitins(dst, not_mask_imm, src, mask_imm, off)                          \
  __builtin_binsert(dst, not_mask_imm, src, mask_imm, off)
#else
#define bitins(dst, not_mask_imm, src, mask_imm, off)                          \
  __builtin_pulp_binsert(dst, not_mask_imm, src, mask_imm, off)
#endif
...
#define MacLoadInit(a_update, b_update, a_reg, b_reg, ptr)                     \
  __builtin_pulp_mlinitspr_v3(a_update, b_update, a_reg, b_reg, ptr)
#define MacLoadUpdate(ptr) __builtin_pulp_mlupdatespr_v3(ptr)
#define MacLoadAssign(ptr) __builtin_pulp_mlassignspr_v3(ptr)
#define MacLoad4(a_update, b_update, a_reg, b_reg, ptr, sum)                   \
  __builtin_pulp_mlsdotsup4_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
#define MacLoad8(a_update, b_update, a_reg, b_reg, ptr, sum)                   \
  __builtin_pulp_mlsdotsup8_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
#define MacLoad16(a_update, b_update, a_reg, b_reg, ptr, sum)                  \
  __builtin_pulp_mlsdotsup16_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
#define MacLoads4(a_update, b_update, a_reg, b_reg, ptr, sum)                  \
  __builtin_pulp_mlsdotsp4_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
#define MacLoads8(a_update, b_update, a_reg, b_reg, ptr, sum)                  \
  __builtin_pulp_mlsdotsp8_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
#define MacLoads16(a_update, b_update, a_reg, b_reg, ptr, sum)                 \
  __builtin_pulp_mlsdotsp16_v3(a_update, b_update, a_reg, b_reg, ptr, sum)
...
pulp_nn_quant_u2(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  uint8_t res = clip2(x);
  return res;
}
...
static uint8_t __attribute__((noinline))
pulp_nn_add_quant_u2(uint8_t pix1, uint8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
...
pulp_nn_quant_i2(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  int8_t res = clips2(x);
  return res;
}
...
static int8_t __attribute__((noinline))
pulp_nn_add_quant_i2(int8_t pix1, int8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
...
static uint8_t __attribute__((noinline))
pulp_nn_quant_u4(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  uint8_t res = clip4(x);
  return res;
}
...
static uint8_t __attribute__((noinline))
pulp_nn_add_quant_u4(uint8_t pix1, uint8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
  uint32_t integer_image = pix1 * m1 + pix2 * m2;
  uint32_t x = (integer_image) >> d;
  uint8_t res = clip4(x);
...
static int8_t __attribute__((noinline))
pulp_nn_quant_i4(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  int8_t res = clips4(x);
  return res;
}
...
static int8_t __attribute__((noinline))
pulp_nn_add_quant_i4(int8_t pix1, int8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
  int32_t integer_image = pix1 * m1 + pix2 * m2;
  int32_t x = (integer_image) >> d;
  int8_t res = clips4(x);
...
static uint8_t __attribute__((noinline))
pulp_nn_quant_u8(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  uint8_t res = clip8(x);
  return res;
}
...
static uint8_t __attribute__((noinline))
pulp_nn_add_quant_u8(uint8_t pix1, uint8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
  uint32_t integer_image = pix1 * m1 + pix2 * m2;
  uint32_t x = (integer_image) >> d;
  uint8_t res = clip8(x);
...
static int8_t __attribute__((noinline))
pulp_nn_quant_i8(int32_t phi, int16_t m, int8_t d) {
  int32_t x = (m * phi) >> d;
  int8_t res = clips8(x);
  return res;
}
...
static int8_t __attribute__((noinline))
pulp_nn_add_quant_i8(int8_t pix1, int8_t pix2, int16_t m1, int16_t m2,
                     int8_t d) {
  int32_t integer_image = pix1 * m1 + pix2 * m2;
  int32_t x = (integer_image) >> d;
  int8_t res = clips8(x);
...
static uint8_t __attribute__((noinline))
pulp_nn_u4_quant(int input, int16_t *pThr) {
  if (input <= pThr[7]) {
    if (input <= pThr[3]) {
      if (input <= pThr[1]) {
        if (input <= pThr[0])
...
static uint8_t __attribute__((noinline))
pulp_nn_u2_quant(int input, int16_t *pThr) {
  if (input <= pThr[1]) {
    if (input <= pThr[0]) {
      return 0;
    } else {
...
static v4u __attribute__((noinline)) pulp_nn_u4_to_u8_r(uint8_t *pSrc) {
  ...
  v4u res =
      pack((uint8_t)bext1, (uint8_t)bext2, (uint8_t)bext3, (uint8_t)bext4);
...
static int8_t *__attribute__((always_inline))
pulp_nn_i4_to_i8(int8_t *pSrc, int8_t *pDst) {
  v4s Src = *((v4s *)pSrc);
  int8_t bext1, bext2, bext3, bext4;
  ...
  bext4 = (int8_t)bitext((int)Src, 4, 12);
  *((v4s *)pDst) =
      pack((int8_t)bext1, (int8_t)bext2, (int8_t)bext3, (int8_t)bext4);
  MemoryFence();
  pDst += 4;
...
pulp_nn_u4_to_u8(uint8_t *pSrc, uint8_t *pDst) {
  v4u Src = *((v4u *)pSrc);
  uint8_t bext1, bext2, bext3, bext4;
...
static int8_t *__attribute__((always_inline))
pulp_nn_i2_to_i8(int8_t *pSrc, int8_t *pDst) {
  v4s Src = *((v4s *)pSrc);
  int8_t bext1, bext2, bext3, bext4;
...
static uint8_t *__attribute__((always_inline))
pulp_nn_u2_to_u8(uint8_t *pSrc, uint8_t *pDst) {
  v4u Src = *((v4u *)pSrc);
  uint8_t bext1, bext2, bext3, bext4;
...
static int8_t *__attribute__((always_inline))
pulp_nn_i2_to_i4(int8_t *pSrc, int8_t *pDst) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static uint8_t *__attribute__((always_inline))
pulp_nn_u2_to_u4(uint8_t *pSrc, uint8_t *pDst) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
  ...
  *((v4u *)pDst) =
      pack((uint8_t)out1, (uint8_t)out2, (uint8_t)out3, (uint8_t)out4);
  MemoryFence();
...
pulp_zero_mem(uint8_t *pBuffer, unsigned int size) {
  int lfover = size & 0x3;
...
static void __attribute__((noinline))
pulp_nn_im2col_u2_to_u8(uint8_t *pInput, uint8_t *pOutput,
...
static void __attribute__((noinline))
pulp_nn_im2col_i2_to_i8(int8_t *pInput, int8_t *pOutput,
                        unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
pulp_nn_im2col_u4_to_u8(uint8_t *pInput, uint8_t *pOutput,
                        unsigned int blockSize) {
...
static void __attribute__((noinline))
pulp_nn_im2col_i4_to_i8(int8_t *pInput, int8_t *pOutput,
                        unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 3u;
  int lfover = blockSize & 0x07;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
pulp_nn_im2col_u8_to_u8(uint8_t *pInput, uint8_t *pOutput,
                        unsigned int blockSize) {
...
static void __attribute__((noinline))
pulp_nn_im2col_i8_to_i8(int8_t *pInput, int8_t *pOutput,
                        unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 2u;
  int lfover = blockSize & 0x03;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u2_to_u2(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i2_to_i2(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u2_to_u4(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i2_to_i4(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u2_to_u8(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i2_to_i8(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 4u;
  int lfover = blockSize & 0x0f;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u4_to_u4(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 3u;
  int lfover = blockSize & 0x07;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i4_to_i4(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 3u;
  int lfover = blockSize & 0x07;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u4_to_u8(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 3u;
  int lfover = blockSize & 0x07;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i4_to_i8(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 3u;
  int lfover = blockSize & 0x07;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_u8_to_u8(uint8_t *pInput, uint8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 2u;
  int lfover = blockSize & 0x03;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
xpulp_nn_im2col_i8_to_i8(int8_t *pInput, int8_t *pOutput,
                         unsigned int blockSize) {
  unsigned int blkCnt = blockSize >> 2u;
  int lfover = blockSize & 0x03;
  for (int i = 0; i < blkCnt; i++) {
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_u8(uint8_t *base, uint8_t *target,
                                         uint16_t length) {
  uint8_t *pIn = base;
  uint8_t *pCom = target;
  v4u inp;
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_i8(int8_t *base, int8_t *target,
                                         uint16_t length) {
  int8_t *pIn = base;
  int8_t *pCom = target;
  v4s inp;
...
static void __attribute__((noinline))
pulp_nn_avg_and_replace_u8(uint8_t *base, uint8_t *target, uint16_t length) {
  uint8_t *pIn = base;
  uint8_t *pCom = target;
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_u4(uint8_t *base, uint8_t *target,
                                         uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_i4(int8_t *base, int8_t *target,
                                         uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
pulp_nn_avg_and_replace_u4(uint8_t *base, uint8_t *target, uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_u2(uint8_t *base, uint8_t *target,
                                         uint16_t length) {
  int8_t mask2 = 0x0c;
...
static void __attribute__((noinline))
pulp_nn_compare_and_replace_if_larger_i2(int8_t *base, int8_t *target,
                                         uint16_t length) {
  int8_t mask2 = 0x0c;
  int8_t n_mask2 = ~mask2;
  int8_t mask4 = 0x30;
...
static void __attribute__((noinline))
pulp_nn_avg_and_replace_u2(uint8_t *base, uint8_t *target, uint16_t length) {
  int8_t mask2 = 0x0c;
  int8_t n_mask2 = ~mask2;
  int8_t mask4 = 0x30;
  int8_t n_mask4 = ~mask4;
...
static void __attribute__((noinline))
xpulp_nn_zero_mem_u8(uint8_t *pBuffer, unsigned int size) {
  int lfover = size & 0x3;
  for (int i = 0; i < (size >> 2); i++) {
    *((v4u *)pBuffer) = (v4u){0, 0, 0, 0};
    MemoryFence();
...
static void __attribute__((noinline))
xpulp_nn_zero_mem_u4(uint8_t *pBuffer, unsigned int size) {
  int lfover = size & 0x7;
...
static void __attribute__((noinline))
xpulp_nn_zero_mem_u2(uint8_t *pBuffer, unsigned int size) {
  int lfover = size & 0xf;
...
static void __attribute__((noinline))
xpulp_nn_compare_and_replace_if_larger_u4(uint8_t *base, uint8_t *target,
                                          uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
xpulp_nn_compare_and_replace_if_larger_i4(int8_t *base, int8_t *target,
                                          uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
xpulp_nn_avg_and_replace_u4(uint8_t *base, uint8_t *target, uint16_t length) {
  int8_t mask = 0xf0;
  int8_t n_mask = ~mask;
  int8_t off = 0x04;
...
static void __attribute__((noinline))
xpulp_nn_compare_and_replace_if_larger_u2(uint8_t *base, uint8_t *target,
                                          uint16_t length) {
  int8_t mask2 = 0x0c;
  int8_t n_mask2 = ~mask2;
  int8_t mask4 = 0x30;
...
static void __attribute__((noinline))
xpulp_nn_compare_and_replace_if_larger_i2(int8_t *base, int8_t *target,
                                          uint16_t length) {
  int8_t mask2 = 0x0c;
  int8_t n_mask2 = ~mask2;
  int8_t mask4 = 0x30;
...
static void __attribute__((noinline))
xpulp_nn_avg_and_replace_u2(uint8_t *base, uint8_t *target, uint16_t length) {
  int8_t mask2 = 0x0c;
  int8_t n_mask2 = ~mask2;
  int8_t mask4 = 0x30;
  int8_t n_mask4 = ~mask4;
