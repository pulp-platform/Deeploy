 ...
 * @param momentum       EMA coefficient (currently unused — running stats not
 * updated)
 */
 ...
 * @param H_in           Spatial height
 * @param W_in           Spatial width
 * @param epsilon        Numerical stability term (unused — inv_std already
 * computed)
 */
...
/**
 * @brief Welford reduction: compute per-channel mean and 1/sqrt(var+eps) over
 * (N,H,W).
 *
 ...
 * @param H_in           Spatial height
 * @param W_in           Spatial width
 * @param N_total_inv    1.0f / (N * H_full * W_full) — must be pre-computed
 * with FULL spatial dims (not tile dims) for correct BN gradient.
 */
