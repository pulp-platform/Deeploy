...
# Training tests for GAP9 (non-tiled, forward + backward + optimizer).
#
...
TRAINING_TESTS = {
    ...
    # NOTE: Transformer_Train and CCT_Train/CCT2_FT1 are disabled because
    # they use a single-output SoftmaxCrossEntropyLoss variant that is not
    # supported on either Siracusa or GAP9 (pre-existing issue).
}
