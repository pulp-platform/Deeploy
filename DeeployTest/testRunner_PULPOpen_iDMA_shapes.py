...
from Deeploy.Targets.PULPOpen_iDMA.DMA.iDMA import iDMA
...
testRunner = TestRunner('PULPOpen_iDMA', 'vsim', True, testRunnerArgumentParser)
...
transformer = CodeTransformation([
    ...
    PULPClusterTiling(defaultMemory, targetMemory, iDMA()),
