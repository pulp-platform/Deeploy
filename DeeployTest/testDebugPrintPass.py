...
if __name__ == "__main__":
    ...
    parser = TestGeneratorArgumentParser(description = "Deeploy Code Generation Utility with Debug Printing")
    ...
    _DEEPLOYSTATEDIR = os.path.join(_GENDIR, "TEST_DEBUGPRINTPASS", "deeployStates")
    ...
    deployer.loweringOptimizer.passes.append(DebugPrintPass(r'.*', position = 'after'))

    deployer.generateFunction()

    print("DebugPrint Test passed.")
