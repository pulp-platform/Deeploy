...
from Deeploy.Targets.NE16.Templates.ConvTemplate import NE162DPWConvTemplate, getInputAddrOffset, \
...
class NE16PWConv2DTileConstraint(TileConstraint):
    ...
    def serializeTilingSolution(
        ...
        for cube in outputCubes:
            ...
            nKo, nKi, nHo, nWo, bKo, bKi, bHo, bWo, bHi, bWi = NE162DPWConvTemplate.getCounters(
...
class NE16RQSPWConv2DTileConstraint(NE16PWConv2DTileConstraint):

    @staticmethod
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        tilerModel = NE16PWConv2DTileConstraint.addGeometricalConstraint(tilerModel, parseDict, ctxt)
