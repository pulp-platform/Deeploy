...
from Deeploy.Targets.NE16.Templates.ConvTemplate import NE162DDenseConvTemplate, getInputAddrOffset, \
...
class NE16DenseConv2DTileConstraint(TileConstraint):
    ...
    def serializeTilingSolution(
        ...
        for cube in outputCubes:
            ...
            nKo, nKi, nHo, nWo, bKo, bKi, bHo, bWo, bHi, bWi = NE162DDenseConvTemplate.getCounters(
...
class NE16RQSDenseConv2DTileConstraint(NE16DenseConv2DTileConstraint):

    @staticmethod
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        tilerModel = NE16DenseConv2DTileConstraint.addGeometricalConstraint(tilerModel, parseDict, ctxt)
