...
from Deeploy.Targets.Generic.Bindings import BasicAddBindings, BasicConv1DBinding, BasicConv2DBindings, \
    ...
    BasicLayerNormBindings, BasicMatMulBindings, BasicMaxPool1DBindings, BasicMaxPool2DBindings, BasicMulBindings, BasicPad1DBindings, \
    ...
    BasicSoftmaxBindings, BasicTransposeBindings, DummyBinding, BasicBatchNormBindings, BasicConvTransposeBindings
from Deeploy.Targets.Generic.Layers import AddLayer, ConcatLayer, ConvLayer, DebugPrintLayer, DequantLayer, DivLayer, GatherLayer, \
    ...
    SliceLayer, SoftmaxLayer, TransposeLayer, BatchNormalizationLayer, ConvTransposeLayer
from Deeploy.Targets.Generic.Parsers import AddParser, ConcatParser, DebugParser, DequantParser, DivParser, DummyParser, \
...
MaxPool1DMapper = NodeMapper(MaxPool1DParser(), [BasicMaxPool1DBinding])
