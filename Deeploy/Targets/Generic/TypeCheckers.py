...
class GroupNormGradXStatChecker(SignPropTypeChecker):
    """TypeChecker for GroupNormGradXStat - computes intermediate gradient statistics."""
...
class GroupNormGradXChecker(SignPropTypeChecker):
...
class GroupNormGradWChecker(SignPropTypeChecker):
...
class GroupNormGradBChecker(SignPropTypeChecker):
...
class GroupNormalizationChecker(SignPropTypeChecker):
