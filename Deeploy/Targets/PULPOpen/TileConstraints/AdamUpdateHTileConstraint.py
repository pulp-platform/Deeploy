...
_TILED_TENSORS = ['X', 'G', 'H', 'H_new']
_ARRAY_INPUT_TENSORS = ['X', 'G', 'H']


class AdamUpdateHTileConstraint(TileConstraint):
    ...
    def serializeTilingSolution(
        ...
        for cube in outputCubes:
            outputLoadSchedule.append({'H_new': cube})
