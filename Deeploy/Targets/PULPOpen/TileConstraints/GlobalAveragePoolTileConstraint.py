...
class GlobalAveragePoolTileConstraint(TileConstraint):
    ...
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        ...
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName = data_out_name, dimIdx = 0) == tilerModel.getTensorDimVar(
                tensorName = data_in_name, dimIdx = 0))
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName = data_out_name, dimIdx = 1) == tilerModel.getTensorDimVar(
    ...
    def serializeTilingSolution(
        ...
        for cube in output_cubes:
            ...
            in_cube = HyperRectangle((cube.offset[0], c_start, 0, 0), (cube.dims[0], C_tile, H, W))
...
class GlobalAveragePoolGradTileConstraint(TileConstraint):
    ...
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        ...
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName = dY_name, dimIdx = 0) == tilerModel.getTensorDimVar(
                tensorName = dX_name, dimIdx = 0))
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName = dY_name, dimIdx = 1) == tilerModel.getTensorDimVar(
                tensorName = dX_name, dimIdx = 1))
    ...
    def serializeTilingSolution(
        ...
        for cube in output_cubes:
            ...
            dy_cube = HyperRectangle((cube.offset[0], c_start, 0, 0), (cube.dims[0], C_tile, 1, 1))
