...
class MaxPoolGradCTileConstraint(TileConstraint):
    ...
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        ...
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName=gradInName, dimIdx=numDims - 1) ==
            tilerModel.getTensorDimVar(tensorName=gradOutName, dimIdx=numDims - 1))
        tilerModel.addConstraint(
            tilerModel.getTensorDimVar(tensorName=xInName, dimIdx=numDims - 1) ==
            tilerModel.getTensorDimVar(tensorName=gradOutName, dimIdx=numDims - 1))
