...
class FloatGEMMTileConstraint(TileConstraint):
    ...
    def addGeometricalConstraint(tilerModel: TilerModel, parseDict: Dict, ctxt: NetworkContext) -> TilerModel:
        ...
        tilerModel.addConstraint(outputSecondDimVar == addDimVar_1)
    ...
    def serializeTilingSolution(
        ...
        # replacementTypes = {
        #     "M": PointerClass(float32_t),
        #     "N": PointerClass(float32_t),
        #     "O": PointerClass(float32_t),
        #     "batch": PointerClass(float32_t)
        # }
