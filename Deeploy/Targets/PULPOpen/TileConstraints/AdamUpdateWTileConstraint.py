...
_TILED_TENSORS = ['R', 'X', 'V_new', 'H_new', 'T', 'W_new']
_ARRAY_INPUT_TENSORS = ['X', 'V_new', 'H_new']


class AdamUpdateWTileConstraint(TileConstraint):
    ...
    def serializeTilingSolution(
        ...
        for cube in outputCubes:
            outputLoadSchedule.append({'W_new': cube})
