...
class _RQSPerturbUniform_i32_Template(NodeTemplate):
...
referenceTemplate = _RQSPerturbUniform_i32_Template("""
// PerturbUniform_i32 (Name: ${nodeName}, Op: ${nodeOp})
...
if isinstance(log2D, int):
    ...
    log2Dstring = "*"+log2D
%>
ApplyPerturbQuantUniform_i32((const int32_t *)  &${data_in}[${nodeName}_chunk_start],
