...
from Deeploy.Targets.PULPOpen.Tiler import PULPAddTilingReadyBindings, PULPConcatTilingReadyBindings, \
    PULPFGEMMTilingReadyBindings, PULPFlattenTilingReadyBindings, PULPiHardswishTilingReadyBindings, \
...
FloatGEMMMapper = NodeMapper(GEMMParser(), PULPFGEMMTilingReadyBindings)
