...
from Deeploy.Targets.PULPOpen.Tiler import PULPAddTilingReadyBindings, PULPConcatTilingReadyBindings, \
    ...
    PULPReduceSumTilingReadyBindings, PULPReluTilingReadyBindings, PULPReluGradTilingReadyBindings, \
    ...
    PULPAveragePoolGrad2DTilingReadyBindings, PULPConvGradX2DTilingReadyBindings, PULPConvGradW2DTilingReadyBindings, \
    PULPDWConvGradX2DTilingReadyBindings, PULPDWConvGradW2DTilingReadyBindings, PULPPWConvGradW2DTilingReadyBindings, \
...
PULPMapping = {
    ...
    'GroupNormForward': GroupNormalizationLayer([GroupNormalizationMapper])
