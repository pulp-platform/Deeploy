...
XHeepOptimizer = TopologyOptimizer(
    [
        QuantPatternPass(),
        DequantPatternPass(),
        iGELURequantMergePass(),
...
class XHeepPlatform(DeploymentPlatform):

    def __init__(self,
                 engines = [XHeepEngine("XHeep")],
                 variableBuffer = XHeepVariableBuffer,
                 constantBuffer = XHeepConstantBuffer,
                 structBuffer = XHeepStructBuffer,
                 transientBuffer = XHeepTransientBuffer):
